    ...
    tideforecast: {
        ...
        onSelect: function(){
            ...
            if (ocean.variable == 'tide'){
                ...
                var BASE_URL = "http://reg.bom.gov.au/australia/tides/scripts/getNextTides.php?";
                var base_pdf_url = "http://reg.bom.gov.au/ntc/IDO59001/IDO59001_";
                ...
                $.getJSON("config/comp/tideforecast.json",function(data) {
                             ...
                             .done(function(points) {
                               for (var i = 0; i < points.length; i++) {
                                 var web_url =  "http://reg.bom.gov.au/australia/tides/#!/offshore-" + points[i][4].trim();
